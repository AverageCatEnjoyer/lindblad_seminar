...
ax.plot(times,result_qutip.expect[0],c='red',label=r'Lindblad, $L \propto \sigma_+$')
ax.plot(times,result_qutip_y.expect[0],c='orange',label=r'Lindblad, $L \propto \sigma_-$')

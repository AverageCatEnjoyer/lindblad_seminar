...
L_1spin = a*sigmap.copy() + a*sigmam.copy()
L_1spin_y = 2*a*sigmap.copy() + a*sigmam.copy()
L_1spin_v = 0.5*a*sigmap.copy() + a*sigmam.copy()
...
ax.plot(times,result_qutip_y.expect[0],c='brown',label=r'$\alpha = 2\beta$')

ax.plot(times,result_qutip.expect[0],c='orange',label=r'$\alpha = \beta$')

ax.plot(times,result_qutip_v.expect[0],c='purple',label=r'$\alpha = \frac{1}{2}\beta$')
